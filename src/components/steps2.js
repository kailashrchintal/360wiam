          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text28">Initial Consultation</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      We start by understanding your organization&apos;s IAM
                      needs and challenges through a detailed consultation.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Our team designs a tailored IAM solution that aligns with
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      We seamlessly implement and integrate the IAM solution
                      into your existing infrastructure, ensuring minimal
                      disruption.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Our experts provide ongoing support and monitoring to
                      ensure the IAM system operates efficiently and securely.
                    </span>
                  </Fragment>
                )}
              </span>
